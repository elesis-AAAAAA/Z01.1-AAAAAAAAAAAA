...
public class CodeAV421B {
     ...
     */
    public CodeAV421B(String filename) throws FileNotFoundException,IOException {
 ...
 //           commands.add("   ");
     ...
     */
    public void writePushPop(ParserAV421B.CommandType command, String segment, Integer index) {
        ...
        if(command == ParserAV421B.CommandType.C_POPP) {
        ...
        } else if(command == ParserAV421B.CommandType.C_POP) {
        ...
        } else if (command == ParserAV421B.CommandType.C_PUSH) {
